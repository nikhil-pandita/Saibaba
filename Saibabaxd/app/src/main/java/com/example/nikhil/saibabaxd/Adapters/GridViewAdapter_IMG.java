 ...
 */
public class GridViewAdapter_IMG extends BaseAdapter {
    ...
    public GridViewAdapter_IMG(ArrayList<String> result ,Context context) {
        Img = result;
        cont = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.imageviewer_grid,null);
